...
export function SohaOrbit({ state }: SohaOrbitProps) {
  return (
    <svg
      aria-hidden="true"
    ...
    >
      ...
      <g className="soha-companion-orbit__body">
        ...
        <rect className="soha-companion-orbit__head" x="39" y="47" width="102" height="91" rx="38" />
        <path className="soha-companion-orbit__face" d="M57 79c20-18 46-18 66 0v28c-20 17-46 17-66 0Z" />
