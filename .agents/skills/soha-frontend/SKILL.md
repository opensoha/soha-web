...
- `scripts/check-table-boundaries.mjs` inventories production table imports. `--enforce` requires
  `TABLE_BOUNDARY_BASE_REF` to identify the reviewed base commit before HEAD; CI supplies the PR
